...
and expr =
  | Cst of int (* constante integer *)
  | Bool of bool (* constante booleana *)
  | Str of string (* constante string *)
  | NoneLit (* constante none *)
  | Var of string (* variável *)
  | Binop of binop * expr * expr (* operação binária *)
  | Unop of unop * expr (* operação unária *)
