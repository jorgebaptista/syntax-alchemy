...
type 'a asm
(** abstract type of assembly code. The parameter ['a] is used as a phantom
    type. *)
...
(** [pushq r] places the contents of [r] at the top of the stack. Reminder: %rsp
    points to the address of the last occupied slot. *)
...
(** inserts a comment in the generated code. May appear in the text or data
    section. *)
